#!/usr/bin/bash
#SBATCH --nodes 1 --ntasks 1 --mem 16gb --time 4:00:00 -J gsnap.makebam --out logs/gsnap_makebam.%a.log
...
infile=${INDIR}/${SAMPLE}.r${REP}.gsnap.sam
bam=${INDIR}/${SAMPLE}.r${REP}.gsnap.bam
echo "$infile $bam"
