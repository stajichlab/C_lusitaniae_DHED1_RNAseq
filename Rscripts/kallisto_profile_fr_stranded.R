...
write.csv(txi.kallisto$abundance,"reports/kallisto_stranded_fr.TPM.csv")
write.csv(txi.kallisto$counts,"reports/kallisto_stranded_fr.counts.csv")
...
pdf("plots/RNASeq_kallisto_stranded_fr.pdf")
